 ...
 * @LastEditors: tao.xu
 * @LastEditTime: 2022-10-10 14:30:01
 */
      ...
      children: [
        {
          ...
          component: () =>
            import(
              /* webpackChunkName: "tinymce" */ '@/views/components-demo/TinymceModulesDemo.vue'
            ),
          name: 'TinymceDemo',
          meta: {
            title: 'tinymce'
        ...
        },
        {
          ...
          component: () =>
            import(
              /* webpackChunkName: "draggable-dialog" */ '@/views/components-demo/DraggableDialogDemo.vue'
            ),
        ...
        },
        {
          ...
          component: () =>
            import(
              /* webpackChunkName: "draggable-kanban" */ '@/views/components-demo/DraggableKanBanDemo.vue'
            ),
